...
import { Program, DEFAULT_PROGRAM_TEMPLATES, ProgramTemplate } from '../../shared/models/program.model';
@Component({
  selector: 'app-program-list',
  standalone: true,
  imports: [RouterLink, Button, Card, Dialog, ConfirmDialog],
    ...
    <div class="program-list">
      <div class="page-header">
        ...
        <div class="header-actions">
          <p-button label="Import Template" icon="pi pi-download" [outlined]="true"
      ...
      @if (programs().length === 0) {
        <p-card styleClass="empty-card">
          <div class="empty-state">
            ...
            <p>No programs yet</p>
            <p class="hint">Create a custom program or import a pre-built template to get started.</p>
            ...
            <p-card styleClass="program-card">
              <div class="program-content">
                ...
                <div class="program-actions">
                  ...
                  <p-button icon="pi pi-pencil" [outlined]="true" (onClick)="editProgram(program)" />
      ...
      <p-dialog header="Import Program Template" [(visible)]="showTemplates" [modal]="true"
        ...
        <div class="template-list">
          @for (template of templates; track template.name) {
            <div class="template-item">
              ...
              <p-button label="Import" icon="pi pi-download" (onClick)="importTemplate(template)"
                        [loading]="importing()" />
            </div>
          }
        </div>
  ...
  styles: [`
    ...
    @media (max-width: 600px) {
      ...
      .template-item { flex-direction: column; }
    }
  `]
})
